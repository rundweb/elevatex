    ...
    <section className="min-h-screen max-w-screen-xl m-auto grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 items-center justify-center p-4">
      <div className="w-full flex flex-col gap-2">
        <div>
          ...
          >
            Empowering <span>Businesses</span> with <span>Smart</span> Digital{" "}
            <span>Strategies</span>
          </h1>

          <h2
            className="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400 max-w-lg"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
        ...
        <div
          className="w-full flex flex-col gap-4 items-center justify-center md:flex-row md:justify-start flex-wrap"
          data-aos="fade-up"
          data-aos-duration="1000"
        >
